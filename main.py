...
def main():
    ...
    file_content_native = my_input.read_from_file_native('data/input.txt')

    file_content_pandas = my_input.read_from_file_with_pandas('data/input.csv')
    ...
    for file in files:
        my_output.write_to_file_native('data/output.txt', file)
